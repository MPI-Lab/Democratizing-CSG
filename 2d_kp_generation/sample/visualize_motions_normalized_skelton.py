    ...
    for file_name in files:
        if file_name.endswith('.npy'):
            ...
            for i in range(len(motions)):
                length = lengths[i]
                motion_valid = motions[i].transpose(2, 0, 1)[:length]
                origin_file = origin_files[i]
                original_folder = "/home/yangxu/tencent-cospeech/2d_kp_generation_fixed/dataset_local/initial_1h/_val/split_segments"
